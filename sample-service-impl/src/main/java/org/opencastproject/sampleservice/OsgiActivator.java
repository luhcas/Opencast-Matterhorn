...
public class OsgiActivator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
    	...
    	jaxRsRegistration = context.registerService(
    			OpencastRestService.class.getName(),
    			new SampleRestService(), null);
    ...
    public void registerStaticWebResources(BundleContext context) {
		...
		staticFilesRegistration = context.registerService( Resources.class.getName(),
