...
public interface BundleReference {
	 ...
	 * the reference point to an element inside the bundle
	 * (see {@link BundleElement#getIdentifier()}).
	 * <p>
	 * In case of a reference to another bundle, this will reflect the bundle
	 * id (see {@link Bundle#getIdentifier()}) or <code>self</code> if it refers
