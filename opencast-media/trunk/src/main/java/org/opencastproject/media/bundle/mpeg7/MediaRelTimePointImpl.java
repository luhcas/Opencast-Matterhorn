 ...
 * @version $Id$
 */
public class MediaRelTimePointImpl extends MediaTimePointImpl implements
    MediaTimePoint {
   ...
   */
  public MediaRelTimePointImpl(int hour, int minute, int second, int fraction,
  ...
  public String toString() {
    ...
    String result = null;
    result = f.format("T%02d:%02d:%02d:%dF%d", hour, minute, second, fractions,
