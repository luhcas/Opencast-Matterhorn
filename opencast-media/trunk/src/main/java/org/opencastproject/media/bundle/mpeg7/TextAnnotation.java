...
public interface TextAnnotation extends XmlElement {
  ...
  /**
   * Returns the confidence of the validity of this annotation. The value will
   * be in the range of <code>0.0</code> and <code>1.0</code>.
   * 
   ...
   * recognition usually has a better confidence value than speech recognition.
   * 
