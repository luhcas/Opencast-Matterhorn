...
public interface BundleElement extends Comparable<BundleElement> {
	...
	/** The manifest type */
	enum Type { Manifest, Timeline, Track, Catalog, Attachment, Other };
	...
	/**
	 * Returns a reference to another entitiy, both inside or outside the
	 * bundle.
	 * 
	 ...
	 * <code>/home/replay/archive/mybundle/tracks</code>.
	 * 
	 * @return the path
	 */
	String getPath();
	...
	/**
	 * Returns the element's mimetype as found in the ISO Mime Type
	 * Registrations.
	 * <p>
	 * For example, in case of motion jpeg slides, this method
	 * will return the mime type for <code>video/mj2</code>.
	 * 
	...
	/**
	 * This method returns the element's xml representation which is used to
	 * store it's characteristic data in the bundle manifest.
	 * 
	 * @param document the parent
     ...
     *
     * @param dest the element's new destination. Note that a <em>file</em>, not a directory must be provided here
     * @throws IOException
     */
	 ...
	 * <p>
	 * Note that an element can only have one reference. Therefore, any
	 * existing reference will be replaced. Also note that if this element
	 * is part of a bundle, a consistency check will be made making sure the
	 * refered element is also part of the same bundle. If not, a
	 * {@link BundleException} will be thrown. 
	 * 
	 * @param element 
