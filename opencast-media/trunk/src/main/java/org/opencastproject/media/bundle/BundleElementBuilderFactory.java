...
/**
 * Factory to retreive instances of a bundle element builder. Use the static method
 * {@link #newInstance()} to obtain a reference to a concrete implementation of a 
 * <code>BundleElementBuilderFactory</code>. This instance can then be used to
 * create or load bundle elements.
 * <p>
 * The factory can be configured by specifying the concrete implementation class through
 * the system property <code>opencast.BundleElementBuilderFactory</code>.
 * </p>
 * 
...
public final class BundleElementBuilderFactory {
	 ...
	 */
	public static BundleElementBuilderFactory newInstance() throws ConfigurationException {
		return factory;
	}
	 ...
	 * <ul>
	 * <li>Implementation specified using the <code>opencast.bundleelementbuilder</code> system property</li>
