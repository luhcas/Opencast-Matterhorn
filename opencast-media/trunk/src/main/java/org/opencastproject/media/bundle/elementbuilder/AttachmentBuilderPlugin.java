 ...
 * @version $Id$
 */
public class AttachmentBuilderPlugin extends AbstractAttachmentBuilderPlugin
    implements BundleElementBuilder {

  /**
   * @see org.opencastproject.media.bundle.elementbuilder.AbstractAttachmentBuilderPlugin#accept(java.io.File,
  ...
  public boolean accept(Node elementNode) {
    try {
      ...
      if (flavor != null && !"".equals(flavor)
          && !Attachment.FLAVOR.toString().equals(flavor))
        return false;
