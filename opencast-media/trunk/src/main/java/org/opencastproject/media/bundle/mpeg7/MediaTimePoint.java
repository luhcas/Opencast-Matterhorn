...
/**
 * Media time point represents a time within the track, e. g. the starting
 * time of a video segment.
 * 
...
public interface MediaTimePoint extends XmlElement {
	...
	/**
	 * Returns <code>true</code> if this time point is relative
	 * to another time point, e. g. the starting time point of 
	 * a temporal segment's track.
	 * 
