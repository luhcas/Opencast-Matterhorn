 ...
 * @version $Id$
 */
public class MultimediaContentTypeImpl<S extends ContentSegment> implements MultimediaContentType, Audio, Video, AudioVisual {
	 ...
	 * 
	 * @param type the content element type
