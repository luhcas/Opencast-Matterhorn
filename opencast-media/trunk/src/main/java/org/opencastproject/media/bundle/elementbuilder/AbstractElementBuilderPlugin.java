 ...
 * implementations by providing tests on the filename an mime type of the file in question.
 * 
 * @author Tobias Wunden <tobias.wunden@id.ethz.ch>
 * @version $Id$
 */
public abstract class AbstractElementBuilderPlugin implements BundleElementBuilderPlugin {
	 ...
	 * 
	 * @param mimeType the type to register (e. g. text/xml)
	 * @param description a description for the mime type
	 * @throws UnknownFileTypeException if the mime type is not known
	 */
	...
	/**
	 * Returns <code>true</code> if the file's mime type could be detected,
