...
public class BundleReferenceImpl implements BundleReference {
	...
	public BundleReferenceImpl(BundleElement bundleElement) {
		if (bundleElement == null)
			throw new IllegalArgumentException("Parameter bundle element must not be null");
	 ...
	 */
	public static BundleReference fromString(String reference) throws IllegalArgumentException {
		if (reference == null)
