...
public class ContentSegmentImpl implements ContentSegment, AudioSegment, VideoSegment, AudioVisualSegment {
	...
	/**
	 * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#hasTextAnnotations(float, float)
	 */
	...
	/**
	 * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#hasTextAnnotations(float, float, java.lang.String)
	 */
	...
	/**
	 * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#createTextAnnotation(float, float, String)
	 */
