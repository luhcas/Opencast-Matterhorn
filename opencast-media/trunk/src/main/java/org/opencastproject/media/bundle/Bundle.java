...
public interface Bundle {
	 ...
	 * 
	 * @param flavor the track's flavor
	...
	/**
	 * Returns <code>true</code> if the bundle contains media tracks of any
	 * kind.
	 * 
	...
	/**
	 * Returns the attachments that are part of this bundle and are refering to the
	 * element identified by <code>reference</code>.
	 * 
	 * @param reference the reference
	 ...
	 * @return the attachments with the specified reference
	 */
	Attachment[] getAttachments(BundleElementFlavor flavor, BundleReference reference);

	/**
	 * Returns <code>true</code> if the bundle contains attachments of any
	 * kind.
	 * 
	...
	/**
	 * Returns the catalogs associated with this bundle that matches the
	 * specified flavor.
	 * 
	 * @param flavor the catalog type
	...
	/**
	 * Returns <code>true</code> if the bundle contains catalogs of any
	 * kind.
	 * 
	...
	/**
	 * Returns bundle elements that are neither, attachments, catalogs nor 
	 ...
	 * 
	 * @param flavor element flavor of the unclassified element
	 * @return <code>true</code> if the bundle contains unclassified elements
	 */
	 ...
	 * {@link BundleBuilder} to create a suitable bundle element out of the
	 * file. If the file cannot be recognized as being either a metadata
	 * catalog or multimedia track, it is added as an attachment.
	 * <p>
	 * Note that the implementation is actually <em>moving</em>
	 * the underlying file in the filesystem. Use this method <em>only</em> if
	 * you do not need the bundle element in its originial place anymore.
     * <p>
     * Depending on the implementation, this method may provide significant
     * performance benefits over copying the bundle element.
	 *
	 * @param file the element file
	 ...
	 */
	BundleElement add(File file) throws BundleException, UnsupportedBundleElementException;
	 ...
	 * catalog or multimedia track, it is added as an attachment.
	 * <p>
	 * Depending on the parameter <code>move</code>, the underlying file
     * will be moved or copied to the bundle. Use this <code>move = true</code>
     * <em>only</em> if you do not need the catalog in its originial place anymore.
	 *
	 * @param file the element file
	 * @throws BundleException 
	 * 				if the element cannot be accessed
     ...
     * @see #add(File, boolean)
	 */
	BundleElement add(File file, boolean move) throws BundleException, UnsupportedBundleElementException;
	 ...
	 * <em>only</em> if you do not need the bundle element in its originial
     * place anymore.
     * <p>
     * Depending on the implementation, this method may provide significant
     * performance benefits over
     * copying the bundle element.
	 *
	 * @param element the element
	 * @throws BundleException 
	 * 				if the element cannot be accessed
	 ...
	 */
	void add(BundleElement element) throws BundleException, UnsupportedBundleElementException;

    /**
     * Adds an arbitrary {@link BundleElement} to this bundle. Depending on the
     * parameter <code>move</code>, the underlying file will be moved or copied
     * to the bundle. Use this <code>move = true</code> <em>only</em> if you do
     * not need the catalog in its originial place anymore.
     *
	 * @param element the element
     * @param move true = move the underlying file, false = create a copy
     * @throws BundleException
     * 				if the element cannot be accessed
     * @throws UnsupportedBundleElementException
     * 				if the element is of an unsupported format
     */
	void add(BundleElement element, boolean move) throws BundleException, UnsupportedBundleElementException;
	 ...
	 */
	void add(Track track) throws BundleException, UnsupportedBundleElementException;
     ...
     * <code>move = true</code> <em>only</em> if you do not need the track in
     * its originial place anymore.
     *
     * @param track the track
     * @param move true = move the underlying file, false = create a copy
     * @throws BundleException
     ...
     * 				if the track is of an unsupported format
     */
    void add(Track track, boolean move) throws BundleException, UnsupportedBundleElementException;
	 ...
	 * underlying file in the filesystem. Use this method <em>only</em> if you
	 * do not need the catalog in its originial place anymore.
     * <p>
     * Depending on the implementation, this method may provide significant
	 ...
	 */
	void add(Catalog catalog) throws BundleException, UnsupportedBundleElementException;
     ...
     * bundle. Use this <code>move = true</code> <em>only</em> if you do not
     ...
     * 				if the catalog is of an unsupported format
     */
	void add(Catalog catalog, boolean move) throws BundleException, UnsupportedBundleElementException;
	...
	/**
	 * Adds an attachment to this bundle, actually <em>moving</em> the underlying file in the filesystem.
     * Use this method <em>only</em> if you do not need the attachment in its originial place anymore.
     * <p>
	 ...
	 */
	void add(Attachment attachment) throws BundleException, UnsupportedBundleElementException;

    /**
     * Adds an attachment to this bundle. Depending on the parameter <code>move</code>, the underlying file
     * will be moved or copied to the bundle. Use this <code>move = true</code> <em>only</em> if you do not
     * need the attachment in its originial place anymore.
     *
     ...
     * 				if the attachment is of an unsupported format
     */
    void add(Attachment attachment, boolean move) throws BundleException, UnsupportedBundleElementException;

	/**
	 * Removes an arbitrary bundle element.
	 * 
	 * @param element the bundle element
	 * @throws BundleException 
	...
	/**
	 * Adds a cover to this bundle, actually <em>moving</em> the underlying file in the filesystem.
     * Use this method <em>only</em> if you do not need the cover in its originial place anymore.
     * <p>
     * Depending on the implementation, this method may provide significant performance benefits over
     * copying the cover.
	 *
	 ...
	 */
    void setCover(Cover cover) throws BundleException, UnsupportedBundleElementException;

    /**
     * Adds a cover to this bundle. Depending on the parameter <code>move</code>, the underlying file
     * will be moved or copied to the bundle. Use this <code>move = true</code> <em>only</em> if you do not
     * need the cover in its originial place anymore.
     *
     * @param cover the cover art
     * @param move true = move the underlying file, false = create a copy
     * @throws BundleException
     * 				if the cover cannot be accessed
     * @throws UnsupportedBundleElementException
     * 				if the cover is of an unsupported format
     */
    void setCover(Cover cover, boolean move) throws BundleException, UnsupportedBundleElementException;
	 ...
	 */
	void pack(BundlePackager packager, OutputStream out) throws IOException, BundleException;
