...
package org.opencastproject.media.bundle.attachment;
...
/**
 * This is a specialized implementation for a bundle cover.
 * 
...
public class CoverImpl extends AttachmentImpl implements Cover {
  ...
  public CoverImpl(Attachment attachment) throws Exception {
    super(attachment.getIdentifier(), Cover.FLAVOR, attachment.getMimeType(),
        attachment.getFile(), attachment.getChecksum());
  }
   ...
   */
  protected CoverImpl(File cover) throws IOException, UnknownFileTypeException,
      NoSuchAlgorithmException {
    super(Cover.FLAVOR, cover);
  }

  /**
   * Reads a cover from the specified file and returns it encapsulated in a
   * {@link Cover} object.
   * 
   * @param file
   *          the track file
   ...
   */
  public static CoverImpl fromFile(File file) throws IOException,
      UnknownFileTypeException, NoSuchAlgorithmException {
    return new CoverImpl(file);
  }

  /**
   * @see org.opencastproject.media.bundle.AttachmentImpl#toString()
   */
  @Override
