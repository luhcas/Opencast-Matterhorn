...
public class AudioVisualTrackImpl extends TrackImpl implements AudioVisualTrack {
	 ...
	 */
	protected AudioVisualTrackImpl(BundleElementFlavor flavor, File file, Checksum checksum) throws IOException, UnknownFileTypeException, NoSuchAlgorithmException {
	 ...
	 * 		if the file is of an unknown file type
	 */
	protected AudioVisualTrackImpl(BundleElementFlavor flavor, MimeType mimeType, File file, Checksum checksum) throws IOException, UnknownFileTypeException {
	 ...
	 * 		if the track's checksum cannot be computed
	 */
	protected AudioVisualTrackImpl(BundleElementFlavor flavor, MimeType mimeType, File file) throws IOException, NoSuchAlgorithmException {
	 ...
	 * 		if the track file cannot be accessed
	 */
	protected AudioVisualTrackImpl(String id, BundleElementFlavor flavor, MimeType mimeType, File file, Checksum checksum) throws IOException {
	 ...
	 * 		if the track's checksum cannot be computed
	 */
	protected AudioVisualTrackImpl(BundleElementFlavor flavor, File track) throws IOException, UnknownFileTypeException, NoSuchAlgorithmException {
		super(flavor, track);
	}
	 ...
	 */
	public static AudioVisualTrackImpl fromFile(File file) throws IOException, UnknownFileTypeException, NoSuchAlgorithmException {
	 ...
	 * 		if the md5 checksum cannot be computed
	 */
	public static AudioVisualTrackImpl fromFile(File file, MimeType mimeType, Checksum checksum) throws IOException, UnknownFileTypeException, NoSuchAlgorithmException {
		return new AudioVisualTrackImpl(AudioVisualTrack.FLAVOR, mimeType, file, checksum);
	}
	...
	public Object clone() throws CloneNotSupportedException {
		...
		try {
			t = new AudioVisualTrackImpl(flavor, mimeType, new File(path, fileName), checksum);
			t.duration = duration;
