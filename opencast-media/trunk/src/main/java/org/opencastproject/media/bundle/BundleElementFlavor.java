 ...
 * @version $Id$
 */
public class BundleElementFlavor implements Cloneable, Comparable<BundleElementFlavor>, Serializable {
	 ...
	 * <p>
	 * For example, if the element type is a presentation movie
	 * which is represented as <code>video/x-presentation</code>, this
	 ...
	 * For example, if the element type is a presentation movie
	 * which is represented as <code>video/x-presentation</code>, this
	 * method will return <code>x-presentation</code>.
	 * 
	 * @return the subtype
	 */
	 ...
	 * <p>
	 * A flavor is a hint on a specialized variant of a general element type.
	 * For example, a dublin core file will have a element type of
	 * <code>text/xml</code>. Adding a flavor of <code>Dublin Core</code>
	...
	/**
	 * Returns <code>true</code> if this element type is an equivalent for
	 * the specified type and subtype.
	 * <p>
	 * For example, a gzipped file may have both of these element types
	 ...
	 * 
	 * @param s the bundle flavor
	 * @return the bundle element flavor object
	 * @throws IllegalArgumentException
	 * 		if the string <code>s</code> does not contain a <t>dash</t> to divide
	 * 		the type from subtype.
	 */
	public static BundleElementFlavor parseFlavor(String s) throws IllegalArgumentException {
		if (s == null)
