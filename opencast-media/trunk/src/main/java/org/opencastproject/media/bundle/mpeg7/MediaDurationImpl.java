...
public class MediaDurationImpl implements MediaDuration {
   ...
   */
  public static MediaDuration parseDuration(String text)
      throws IllegalArgumentException {
  ...
  public void parse(String text) throws IllegalArgumentException {
    ...
    if (text.contains(HourDelimiter)) {
      hours = Short.parseShort(text.substring(index + 1, text
          .indexOf(HourDelimiter)));
      index = text.indexOf(HourDelimiter);
    }
    if (text.contains(MinuteDelimiter)) {
      minutes = Short.parseShort(text.substring(index + 1, text
          .indexOf(MinuteDelimiter)));
      index = text.indexOf(MinuteDelimiter);
    }
    if (text.contains(SecondsDelimiter)) {
      seconds = Short.parseShort(text.substring(index + 1, text
          .indexOf(SecondsDelimiter)));
      index = text.indexOf(SecondsDelimiter);
    }
    if (text.contains(FractionDelimiter)) {
      fractions = Integer.parseInt(text.substring(index + 1, text
          .indexOf(FractionDelimiter)));
      index = text.indexOf(FractionDelimiter);
    }
    if (text.contains(FPSDelimiter)) {
      fractionsPerSecond = Integer.parseInt(text.substring(index + 1, text
          .indexOf(FPSDelimiter)));
    }
  }

  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaDuration#getDays()
   */
  public int getDays() {
    return days;
  }
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaDuration#getFractions()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaDuration#getFractionsPerSecond()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaDuration#getHours()
   */
  public int getHours() {
    return hours;
  }
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaDuration#getMinutes()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaDuration#getSeconds()
   */
  ...
  public String toString() {
    ...
    if (fractionsPerSecond != 0) {
      f.format("%d" + FractionDelimiter + "%d" + FPSDelimiter, fractions,
          fractionsPerSecond);
    }
    f.close();
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaDuration#getDurationInMilliseconds()
   */
