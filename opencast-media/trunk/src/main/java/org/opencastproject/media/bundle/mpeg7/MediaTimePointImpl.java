...
public class MediaTimePointImpl implements MediaTimePoint {
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaTimePoint#getDay()
   */
  public int getDay() {
    return day;
  }
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaTimePoint#getHour()
   */
  public int getHour() {
    return hour;
  }
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaTimePoint#getMinutes()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaTimePoint#getMonth()
   */
  public int getMonth() {
    return month;
  }
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaTimePoint#getNFractions()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaTimePoint#getSeconds()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaTimePoint#getYear()
   */
  public int getYear() {
    return year;
  }
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaTimePoint#getFractionsPerSecond()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaTimePoint#getTimeInMilliseconds()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.MediaTimePoint#isRelative()
   */
  ...
  /**
   * Sets a reference time point which makes this time point relative to the
   * given one.
   * 
   * @param timePoint
   *          the reference time point
   ...
   */
  public static MediaTimePointImpl parseTimePoint(String text)
      throws IllegalArgumentException {
  ...
  private void parse(String text) throws IllegalArgumentException {
    ...
    time = text.substring(text.indexOf(TimeSpecDelimiter) + 1, text
        .indexOf(TimeSpecDelimiter) + 9);
    fractions = text.substring(text.indexOf(TimeSpecDelimiter) + time.length()
        + 2);
  ...
  private void parseDate(String date) {
    ...
    if (firstDateSeparator > -1) {
      ...
      month = Short.parseShort(date.substring(firstDateSeparator + 1,
          lastDateSeparator));
  ...
  private void parseTime(String time) {
    ...
    if (firstTimeSeparator > -1) {
      ...
      minute = Short.parseShort(time.substring(firstTimeSeparator + 1,
          lastTimeSeparator));
  ...
  private void parseFractions(String fractions) {
    this.fractions = Integer.parseInt(fractions.substring(0, fractions
        .indexOf(FractionSpecDelimiter)));
    this.fractionsPerSecond = Integer.parseInt(fractions.substring(fractions
        .indexOf(FractionSpecDelimiter) + 1));
  }
  ...
  public String toString() {
    ...
    if (referenceTimePoint == null && year != 0) {
      result = f.format("%04d-%02d-%02dT%02d:%02d:%02d:%dF%d", year, month,
          day, hour, minute, second, fractions, fractionsPerSecond).toString();
    } else {
      result = f.format("T%02d:%02d:%02d:%dF%d", hour, minute, second,
          fractions, fractionsPerSecond).toString();
    }
    f.close();
    return result;
  }
