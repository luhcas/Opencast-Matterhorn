...
public class MediaTimePointImpl implements MediaTimePoint {
	...
	/**
	 * Sets a reference time point which makes this time point relative
	 * to the given one.
	 * 
	 * @param timePoint the reference time point
	 */
	 ...
	 * 
	 * @param text the timepoint text representation
