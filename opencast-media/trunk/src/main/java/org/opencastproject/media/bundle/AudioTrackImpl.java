...
public class AudioTrackImpl extends TrackImpl implements AudioTrack {
   ...
   */
  protected AudioTrackImpl(BundleElementFlavor flavor, File file,
   ...
   *           if the file is of an unknown file type
   */
  protected AudioTrackImpl(BundleElementFlavor flavor, MimeType mimeType,
   ...
   *           if the track file cannot be accessed
   */
  protected AudioTrackImpl(String id, BundleElementFlavor flavor,
   ...
   *           if the track's checksum cannot be computed
   */
  protected AudioTrackImpl(BundleElementFlavor flavor, File track)
   ...
   */
  public static AudioTrackImpl fromFile(File file) throws IOException,
   ...
   *           if the md5 checksum cannot be computed
   */
  public static AudioTrackImpl fromFile(File file, MimeType mimeType,
      Checksum checksum) throws IOException, UnknownFileTypeException,
      NoSuchAlgorithmException {
  ...
  public Object clone() throws CloneNotSupportedException {
    ...
    try {
      t = new AudioTrackImpl(flavor, mimeType, new File(path, fileName),
          checksum);
      t.duration = duration;
