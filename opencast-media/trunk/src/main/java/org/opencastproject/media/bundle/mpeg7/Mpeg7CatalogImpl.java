...
public class Mpeg7CatalogImpl extends XMLCatalog implements Mpeg7Catalog {
     ...
     *
     * @param catalog the dublin core metadata container file
     ...
     */
    public static Mpeg7Catalog fromFile(File catalog) throws IOException, UnknownFileTypeException, ParserConfigurationException, NoSuchAlgorithmException, SAXException {
	 ...
	 * 		if the md5 checksum cannot be computed
	 */
	static Mpeg7CatalogImpl newInstance(Bundle bundle) throws IOException, UnknownFileTypeException, ParserConfigurationException, TransformerException, NoSuchAlgorithmException {
		Mpeg7CatalogImpl mpeg7 = new Mpeg7CatalogImpl(new File(bundle.getRoot(), Mpeg7Catalog.FILENAME));
		mpeg7.save();
		return mpeg7;
	}
	...
	/**
	 * @see org.opencastproject.media.bundle.mpeg7.Mpeg7#addAudioContent(java.lang.String, org.opencastproject.media.bundle.mpeg7.MediaTime, org.opencastproject.media.bundle.mpeg7.MediaLocator)
	 */
	...
	/**
	 * @see org.opencastproject.media.bundle.mpeg7.Mpeg7#addVideoContent(java.lang.String, org.opencastproject.media.bundle.mpeg7.MediaTime, org.opencastproject.media.bundle.mpeg7.MediaLocator)
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * @see org.opencastproject.media.bundle.mpeg7.Mpeg7#addAudioVisualContent(java.lang.String, org.opencastproject.media.bundle.mpeg7.MediaTime, org.opencastproject.media.bundle.mpeg7.MediaLocator)
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * 
	 * @param id the content element identifier
	...
	/**
	 * Parser implementation for mpeg-7 files. Note that this implementation
	 * does by far not cover the full mpeg-7 standard but only deals with
	 * those parts relevant to replay, mainly temporal decompositions. 
	 * 
	 * @author Tobias Wunden <tobias.wunden@id.ethz.ch>
	 */
	static class MPEG7Parser extends DefaultHandler {
		...
		enum ParserState { Document, MultimediaContent, Segment };
		 ...
		 */
		public Mpeg7Catalog parse(File file) throws ParserConfigurationException, SAXException, IOException, NoSuchAlgorithmException, UnknownFileTypeException {
