...
public interface Mpeg7 {
	...
	/**
	 * Returns an iteration of the multimedia content container contained in
	 * this mpeg-7 document.
	 * 
	...
	/**
	 * Returns the multimedia content container element for tracks of the given
	 * type (either <code>Audio></code>, <code>Video</code> or
	 * <code>Audiovisual</code>).
	 * 
	 * 
	 ...
	 * @param time the audio track time constraints
	 * @param locator the track locator
	 */
	...
	/**
	 * Returns <code>true</code> if the catalog contains multimedia content
	 * of type <code>AudioType</code>.
	 * 
	 ...
	 * 
	 * @param id the video track id
	 * @param time the video track time constraints
	 * @param locator the track locator
	 */
	 ...
	 * @param time the track's time constraints
	 * @param locator track's locator
	 */
	...
	/**
	 * Returns <code>true</code> if the catalog contains multimedia content
	 * of type <code>AudioVisualType</code>.
	 * 
	...
	/**
	 * Returns the audio track with the given id or <code>null</code> if the
	...
	/**
	 * Returns the video track with the given id or <code>null</code> if the
	 * track does not exist.
	 * 
	 * @param id the video track id
	...
	/**
	 * Returns the audiovisual track with the given id or <code>null</code> if
