...
public interface Mpeg7 {
  ...
  /**
   * Returns an iteration of the multimedia content container contained in this
   * mpeg-7 document.
   * 
   ...
   */
  MultimediaContent<? extends MultimediaContentType> getMultimediaContent(
  ...
  /**
   * Returns <code>true</code> if the catalog contains multimedia content of
   * type <code>AudioType</code>.
   * 
   ...
   *          track's locator
   */
  AudioVisual addAudioVisualContent(String id, MediaTime time,
  ...
  /**
   * Returns <code>true</code> if the catalog contains multimedia content of
   * type <code>AudioVisualType</code>.
   * 
  ...
  /**
   * Returns the audio track with the given id or <code>null</code> if the track
   * does not exist.
   * 
   * @param id
   *          the audio track id
  ...
  /**
   * Returns the video track with the given id or <code>null</code> if the track
   * does not exist.
   * 
   * @param id
   *          the video track id
  ...
  /**
   * Returns the audiovisual track with the given id or <code>null</code> if the
