...
/**
 * Support class for {@link org.opencastproject.media.analysis.MediaAnalyzer} implementations
 * that use an external program for analysis.
 *
...
public abstract class CmdlineMediaAnalyzerSupport implements MediaAnalyzer {
    ...
    /**
     * Exception handler callback. Any occuring {@link org.opencastproject.media.analysis.MediaAnalyzerException}
