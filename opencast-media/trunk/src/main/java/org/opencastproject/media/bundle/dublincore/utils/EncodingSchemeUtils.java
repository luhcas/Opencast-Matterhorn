...
public class EncodingSchemeUtils {
    ...
    private static final Map<Precision, String> formats = new MapBuilder<Precision, String>()
            .put(Precision.Year, "yyyy")
            .put(Precision.Month, "yyyy-MM")
            .put(Precision.Day, "yyyy-MM-dd")
            .put(Precision.Minute, "yyyy-MM-dd'T'HH:mm'Z'")
            .put(Precision.Second, "yyyy-MM-dd'T'HH:mm:ss'Z'")
            .put(Precision.Fraction, "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'")
            .toMap();
     ...
     * <p/>
     * See <a href="http://www.w3.org/TR/NOTE-datetime">http://www.w3.org/TR/NOTE-datetime</a> for more
     * information about W3C-DTF.
     *
    ...
    /**
     * Encode a period with the given precision into a Dublin Core string value using the recommended
     * DCMI Period scheme and the UTC timezone. One of the dates may be null to create an open interval.
     * <p/>
     * See <a href="http://dublincore.org/documents/dcmi-period/">http://dublincore.org/documents/dcmi-period/</a>
     * for more information about DCMI Period.
     *
    ...
    /**
     * Like {@link #decodeDate(org.opencastproject.media.bundle.dublincore.DublinCoreValue)}, but
     * throws an {@link IllegalArgumentException} if the value cannot be decoded.
     *
     * @return the date
    ...
    /**
     * Tries to decode a string in the DCMI period format, using W3C-DTF for the encoding of the
     * individual dates. If parsing fails at any point, null will be returned.
     *
    ...
    /**
     * Like {@link #decodePeriod(org.opencastproject.media.bundle.dublincore.DublinCoreValue)}, but
     * throws an {@link IllegalArgumentException} if the value cannot be decoded.
     *
     * @return the period
     * @throws IllegalArgumentException if the value cannot be decoded
    ...
    /**
     * Like {@link #decodeTemporal(org.opencastproject.media.bundle.dublincore.DublinCoreValue)}, but
     * throws an {@link IllegalArgumentException} if the value cannot be decoded.
     *
