...
/**
 * This MediaAnalyzer implementation leverages MediaInfo
 * (<a href="http://mediainfo.sourceforge.net/">http://mediainfo.sourceforge.net</a>)
 * for analysis.
 * <p/>
 * <strong>Please note</strong> that this implementation is stateful and cannot be shared
...
public class MediaInfoAnalyzer extends CmdlineMediaAnalyzerSupport {
    ...
    private static final Map<String, Setter> CommonStreamProperties = new MapBuilder<String, Setter>()
            .put("Format", new Setter("format", "string"))
            .put("Format_Profile", new Setter("formatProfile", "string"))
            .put("Format/Info", new Setter("formatInfo", "string"))
            .put("Format/Url", new Setter("formatURL", "url"))
            .put("Duration", new Setter("duration", "duration"))
            .put("BitRate", new Setter("bitRate", "float"))
            .put("BitRate_Mode", new Setter("bitRateMode", "bitRateMode"))
            .put("BitRate_Minimum", new Setter("bitRateMinimum", "float"))
            .put("BitRate_Maximum", new Setter("bitRateMaximum", "float"))
            .put("BitRate_Nominal", new Setter("bitRateNominal", "float"))
            .put("Resolution", new Setter("resolution", "int"))
            .put("Encoded_Date", new Setter("encodedDate", "date"))
            .toMap();

    private static final Map<StreamSection, Map<String, Setter>> Parser = new MapBuilder<StreamSection, Map<String, Setter>>()
            .put(StreamSection.general, new MapBuilder<String, Setter>()
                    .put("FileName", new Setter("fileName", "string"))
                    .put("FileExtension", new Setter("fileExtension", "string"))
                    .put("FileSize", new Setter("size", "long"))
                    .put("Duration", new Setter("duration", "duration"))
                    .put("OverallBitRate", new Setter("bitRate", "float"))
                    .put("Encoded_Date", new Setter("encodedDate", "date"))
                    .toMap())
            .put(StreamSection.video, new MapBuilder<String, Setter>()
                    .putAll(CommonStreamProperties)
                    //
                    .put("Width", new Setter("frameWidth", "int"))
                    .put("Height", new Setter("frameHeight", "int"))
                    .put("PixelAspectRatio", new Setter("pixelAspectRatio", "float"))
                    .put("FrameRate", new Setter("frameRate", "float"))
                    .put("FrameRate_Mode", new Setter("frameRateMode", "frameRateMode"))
                    .put("ScanType", new Setter("scanType", "scanType"))
                    .put("ScanOrder", new Setter("scanOrder", "scanOrder"))
                    .toMap())
            .put(StreamSection.audio, new MapBuilder<String, Setter>()
                    .putAll(CommonStreamProperties)
                    //
                    .put("Channel(s)", new Setter("channels", "int"))
                    .put("ChannelPositions", new Setter("channelPositions", "string"))
                    .put("SamplingRate", new Setter("samplingRate", "int"))
                    .put("SamplingCount", new Setter("samplingCount", "long"))
                    .toMap())
            .toMap();
    ...
    static FrameRateMode convertFrameRateMode(String value) {
        if ("cfr".equalsIgnoreCase(value)) return FrameRateMode.ConstantFrameRate;
        if ("vfr".equalsIgnoreCase(value)) return FrameRateMode.VariableFrameRate;
        throw new RuntimeException("Cannot parse FrameRateMode " + value);
    }

    static ScanType convertScanType(String value) {
        if ("interlaced".equalsIgnoreCase(value)) return ScanType.Interlaced;
        if ("progressive".equalsIgnoreCase(value)) return ScanType.Progressive;
        throw new RuntimeException("Cannot parse ScanType " + value);
    }

    static BitRateMode convertBitRateMode(String value) {
        if ("vbr".equalsIgnoreCase(value)) return BitRateMode.VariableBitRate;
        if ("cbr".equalsIgnoreCase(value)) return BitRateMode.ConstantBitRate;
