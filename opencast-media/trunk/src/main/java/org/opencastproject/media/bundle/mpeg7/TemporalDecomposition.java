...
/**
 * This interface describes that basis for a temporal decomposition of an
 * audio, video or audiovisual content element.
 * 
...
public interface TemporalDecomposition<T extends ContentSegment> extends XmlElement {
	 ...
	 * @version $Id$
	 */
	enum DecompositionCriteria { Temporal };
	
	/**
	 * Set the <code>hasGap</code> property indicating that there may be gaps
	 * in between the segments.
	 * 
	 * @param hasGap <code>true</code> if there are gaps
	 */
	...
	/**
	 * Set the <code>isOverlapping</code> property indicating that some segments
	 * may be overlapping.
	 * 
	 * @param isOverlapping <code>true</code> if elements are overlapping
	 */
	...
	/**
	 * Returns the segment with the given identifier or <code>null</code> if the
