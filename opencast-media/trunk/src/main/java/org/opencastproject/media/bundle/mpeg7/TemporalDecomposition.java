...
/**
 * This interface describes that basis for a temporal decomposition of an audio,
 * video or audiovisual content element.
 * 
 * @author Tobias Wunden <tobias.wunden@id.ethz.ch>
 * @version $Id$
 */
public interface TemporalDecomposition<T extends ContentSegment> extends
    XmlElement {
  ...
  /**
   * Set the <code>hasGap</code> property indicating that there may be gaps in
