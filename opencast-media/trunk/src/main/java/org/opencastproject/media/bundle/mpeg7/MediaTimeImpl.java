...
public class MediaTimeImpl implements MediaTime {
	...
	/**
	 * Creates a media time object representing the given timepoint
	 * and duration.
	 * 
	...
	/**
	 * Creates a media time object from the given long values for
	...
	/**
	 * Creates a media time object from the given string representations for
	 * timepoint and duration.
	 * 
	 * @param time the timepoint string representation
	 * @param duration the duration string representation
	 */
	...
	/**
	 * @see org.opencastproject.media.bundle.mpeg7.MediaTime#getMediaDuration()
	 */
	...
	/**
	 * @see org.opencastproject.media.bundle.mpeg7.MediaTime#getMediaTimePoint()
	 */
