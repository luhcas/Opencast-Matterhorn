 ...
 * @version $Id$
 */
public class TrackImpl extends AbstractBundleElement implements Track, AudioVisualTrack {
	 ...
	 */
	protected TrackImpl(BundleElementFlavor flavor, File file, Checksum checksum) throws IOException, UnknownFileTypeException, NoSuchAlgorithmException {
	 ...
	 * 		if the file is of an unknown file type
	 */
	protected TrackImpl(BundleElementFlavor flavor, MimeType mimeType, File file, Checksum checksum) throws IOException, UnknownFileTypeException {
	 ...
	 * 		if the track's checksum cannot be computed
	 */
	protected TrackImpl(BundleElementFlavor flavor, MimeType mimeType, File file) throws IOException, NoSuchAlgorithmException {
	 ...
	 * 		if the track file cannot be accessed
	 */
	protected TrackImpl(String id, BundleElementFlavor flavor, MimeType mimeType, File file, Checksum checksum) throws IOException {
	 ...
	 * 		if the track's checksum cannot be computed
	 */
	protected TrackImpl(BundleElementFlavor flavor, File track) throws IOException, UnknownFileTypeException, NoSuchAlgorithmException {
	...
	public Node toManifest(Document document) {
		...
		String trackPath = PathSupport.concat(
