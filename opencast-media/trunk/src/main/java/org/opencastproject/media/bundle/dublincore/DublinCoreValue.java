 ...
 * <p/>
 * See <a
 * href="http://dublincore.org/documents/dc-xml-guidelines/">http://dublincore
 * .org/documents/dc-xml-guidelines/</a> for further details.
 * 
...
public class DublinCoreValue implements Serializable {
  ...
  /**
   * Two values are considered equal if their value und language property are
   * equal. The encoding scheme is only taken into account when both values have
   * a scheme set.
   */
  @Override
  public boolean equals(Object o) {
    ...
    if (!language.equals(that.language))
      return false;
    if (encodingScheme != null && that.encodingScheme != null
        && !encodingScheme.equals(that.encodingScheme))
      return false;
    return true;
  }
