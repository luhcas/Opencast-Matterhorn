 ...
 * <p/>
 * See <a href="http://dublincore.org/documents/dc-xml-guidelines/">http://dublincore.org/documents/dc-xml-guidelines/</a>
 * for further details.
 *
...
public class DublinCoreValue implements Serializable {
     ...
     * @param language the language (two letter ISO 639)
     * @param encodingScheme the encoding scheme used to encode the value or null
     */
    ...
    /**
     * Creates a new Dublin Core value with the language set to undefined and no
     * particular encoding scheme.
     *
     * @param value the value
     * @see org.opencastproject.media.bundle.dublincore.DublinCore#LANGUAGE_UNDEFINED
     */
    ...
    /**
     * Two values are considered equal if their value und language property are equal.
     * The encoding scheme is only taken into account when both values have a scheme set.
     */
    @Override
