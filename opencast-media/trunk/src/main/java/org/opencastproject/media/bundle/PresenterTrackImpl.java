...
public class PresenterTrackImpl extends TrackImpl implements PresenterTrack {
	...
	/**
	 * Creates a new presenter track showing the lecturer and optionaly
	 * containing the speaker audio.
	 * 
	 ...
	 */
	protected PresenterTrackImpl(BundleElementFlavor flavor, File track) throws IOException, UnknownFileTypeException, NoSuchAlgorithmException {
		super(flavor, track);
	}
	 ...
	 * 		if the md5 checksum cannot be computed
	 */
	protected PresenterTrackImpl(BundleElementFlavor flavor, MimeType mimeType, File track, Checksum checksum) throws IOException, UnknownFileTypeException, NoSuchAlgorithmException {
	 ...
	 * 		if the md5 checksum cannot be computed
	 */
	public static PresenterTrackImpl fromFile(File file) throws IOException, UnknownFileTypeException, NoSuchAlgorithmException {
	 ...
	 * 		if the md5 checksum cannot be computed
	 */
	public static PresenterTrackImpl fromFile(File file, MimeType mimeType, Checksum checksum) throws IOException, UnknownFileTypeException, NoSuchAlgorithmException {
		return new PresenterTrackImpl(PresenterTrack.FLAVOR, mimeType, file, checksum);
	}
