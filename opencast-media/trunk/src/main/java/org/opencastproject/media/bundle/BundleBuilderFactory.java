 ...
 * {@link #newInstance()} to obtain a reference to a concrete implementation of
 * a <code>BundleBuilderFactory</code>. This instance can then be used to create
 * or load bundles.
 * <p>
 * The factory can be configured by specifying the concrete implementation class
 * through the system property <code>opencast.BundleBuilderFactory</code>.
 * </p>
 * 
...
public final class BundleBuilderFactory {
   ...
   */
  public static BundleBuilderFactory newInstance()
      throws ConfigurationException {
    return factory;
  }
   ...
   * <ul>
   * <li>Implementation specified using the <code>opencast.bundlebuilder</code>
   * system property</li>
    ...
    if (builder == null) {
      try {
        ...
        throw new ConfigurationException(
            "Class not found while creating bundle builder: " + e.getMessage(),
            e);
      } catch (InstantiationException e) {
        throw new ConfigurationException(
            "Instantiation exception while creating bundle builder: "
                + e.getMessage(), e);
      } catch (IllegalAccessException e) {
        throw new ConfigurationException(
            "Access exception while creating bundle builder: " + e.getMessage(),
            e);
      }
    }
    return builder;
