...
public class DublinCoreTest {
    ...
    /**
     * Test method for {@link org.opencastproject.media.bundle.dublincore.DublinCoreCatalogImpl#fromFile(java.io.File)}.
     */
    @Test
    ...
    /**
     * Test method for {@link org.opencastproject.media.bundle.dublincore.DublinCoreCatalogImpl#save()}.
     */
    @Test
    public void testNewInstance() {
        ...
        try {
            ...
            dcNew.add(PROPERTY_LICENSE, new DublinCoreValue("http://replay.ethz.ch/license", DublinCore.LANGUAGE_UNDEFINED,
                    ENC_SCHEME_URI));
            ...
            dcNew.add(PROPERTY_PROMOTED, new DublinCoreValue("true", DublinCore.LANGUAGE_UNDEFINED,
                    new EName("http://ethz.ch/replay", "Boolean")));
            try {
                dcNew.add(PROPERTY_PROMOTED, new DublinCoreValue("true", DublinCore.LANGUAGE_UNDEFINED,
                        new EName("http://ethz.ch/replay/enc-scheme", "Boolean")));
                fail();
