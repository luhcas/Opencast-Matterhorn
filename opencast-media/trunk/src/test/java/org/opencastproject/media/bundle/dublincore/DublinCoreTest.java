...
import static org.opencastproject.media.bundle.dublincore.DublinCore.ENC_SCHEME_URI;
import static org.opencastproject.media.bundle.dublincore.DublinCore.LANGUAGE_ANY;
import static org.opencastproject.media.bundle.dublincore.DublinCore.LANGUAGE_UNDEFINED;
import static org.opencastproject.media.bundle.dublincore.DublinCore.PROPERTY_CONTRIBUTOR;
import static org.opencastproject.media.bundle.dublincore.DublinCore.PROPERTY_IDENTIFIER;
import static org.opencastproject.media.bundle.dublincore.DublinCore.PROPERTY_LICENSE;
import static org.opencastproject.media.bundle.dublincore.DublinCore.PROPERTY_PUBLISHER;
import static org.opencastproject.media.bundle.dublincore.DublinCore.PROPERTY_TITLE;
...
import static org.opencastproject.media.bundle.dublincore.DublinCoreCatalogImpl.PROPERTY_PROMOTED;

import org.opencastproject.media.bundle.DublinCoreCatalog;
import org.opencastproject.media.bundle.EName;
import org.opencastproject.media.bundle.NamespaceBindingException;
...
public class DublinCoreTest {
  ...
  /**
   * Test method for
   * {@link org.opencastproject.media.bundle.dublincore.DublinCoreCatalogImpl#fromFile(java.io.File)}
   * .
   */
  @Test
  public void testFromFile() {
    ...
    assertEquals("ETH Zurich, Switzerland", dc.getFirst(PROPERTY_PUBLISHER,
        LANGUAGE_UNDEFINED));
    assertEquals("Land and Vegetation: Key players on the Climate Scene", dc
        .getFirst(PROPERTY_TITLE, "en"));
  ...
  /**
   * Test method for
   * {@link org.opencastproject.media.bundle.dublincore.DublinCoreCatalogImpl#save()}
   * .
   */
  @Test
  public void testNewInstance() {
    ...
    try {
      ...
      dcNew.add(PROPERTY_LICENSE, new DublinCoreValue(
          "http://replay.ethz.ch/license", DublinCore.LANGUAGE_UNDEFINED,
          ENC_SCHEME_URI));
      // Don't forget to bind the namespace...
      dcNew.bindPrefix("replay", "http://ethz.ch/replay");
      dcNew.add(PROPERTY_PROMOTED, new DublinCoreValue("true",
          DublinCore.LANGUAGE_UNDEFINED, new EName("http://ethz.ch/replay",
              "Boolean")));
      try {
        dcNew.add(PROPERTY_PROMOTED, new DublinCoreValue("true",
            DublinCore.LANGUAGE_UNDEFINED, new EName(
                "http://ethz.ch/replay/enc-scheme", "Boolean")));
        fail();
    ...
    assertEquals(dcSample.getFirst(PROPERTY_IDENTIFIER), dcNewFromDisk
        .getFirst(PROPERTY_IDENTIFIER));
    assertEquals(dcSample.getFirst(PROPERTY_TITLE, "en"), dcNewFromDisk
        .getFirst(PROPERTY_TITLE, "en"));
    assertEquals(dcSample.getFirst(PROPERTY_PUBLISHER), dcNewFromDisk
        .getFirst(PROPERTY_PUBLISHER));
  }
  ...
  @Test
  public void testVarious() throws NoSuchAlgorithmException, IOException,
  ...
  @Test
  public void testVarious2() throws NoSuchAlgorithmException, IOException,
      UnknownFileTypeException {
    DublinCoreCatalog dc = DublinCoreCatalogImpl.newInstance();
    ...
    assertEquals("The Lord of the Rings; Der Herr der Ringe", dc.getAsText(
        PROPERTY_TITLE, LANGUAGE_ANY, "; "));
  ...
  @Test
  public void testVarious3() throws NoSuchAlgorithmException, IOException,
      UnknownFileTypeException {
    DublinCoreCatalog dc = DublinCoreCatalogImpl.newInstance();
  ...
  @Test
  public void testVarious4() throws NoSuchAlgorithmException, IOException,
      UnknownFileTypeException {
    DublinCoreCatalog dc = DublinCoreCatalogImpl.newInstance();
