...
public abstract class AbstractBundleTest {
	...
	public void setUp() throws Exception {
		...
		// Setup test files
		File manifestTestFile = new File(this.getClass().getResource("/manifest.xml").getPath());
		...
		manifestFile = FileSupport.copy(manifestTestFile, new File(bundleDir, Manifest.FILENAME));
	...
	public void tearDown() throws Exception {
		if (bundleDir.getParentFile().getName().equals(identifier.getNamingAuthority()))
