...
public class NumberSupport {
     ...
     * @param formatString a format pattern. See {@link java.text.DecimalFormat} for details
     ...
     *
     * @param f the number to format
     * @param format format to use. Please note that the passed format acts as a template that
     *   gets modified by this method, so don't rely on it!
     * @return the formatted number
     */
