...
public class PathSupport {
	...
	/**
	 * Removes a file extension from the end of the path. If there is no extension or the file name starts with
	 * the extension separator "." <code>path</code> will be returned untouched.
	 *
	...
	/**
	 * Removes any existing file extension from the end of the path and replaces it with
	 * the given one.
	 *
  ...
  /**
	 * Checks that the path only contains the system path separator. If not,
	...
	/**
	 * Removes any occurence of double file separators and replaces
