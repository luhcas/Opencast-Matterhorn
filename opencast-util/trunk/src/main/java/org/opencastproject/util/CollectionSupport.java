...
import static org.opencastproject.util.CollectionSupport.merge;
 ...
 * <p/>
 * Code copied from class <code>appetizer.util.Kollections</code> of project "appetizer",
 * originally create May 24, 2006.
...
public class CollectionSupport {
    ...
    /**
     * Initialisiert <i>collection</i> mit <i>initElement<i>. Das bedeutet, daß <i>collection</i>
     * vorher geleert wird.
     *
     * @param initElement darf <i>null</i> sein, wenn es der Collectiontyp zuläßt.
     */
    ...
    /**
     * Speichert alle Objekte <i>obj</i> in der Collection <i>collection</i>. Nutzt {@link Collections#addAll}, nur
     * daß die Collection zurückgegeben wird und die Methode somit zu Initialisierungszwecken genutzt werden kann.
     *
     * @param obj die zuzufügenden Objekte oder <i>null</i>
     ...
     *
     * @param elements darf <i>null</i> sein
     ...
     *
     * @param collection darf <i>null</i> sein
     * @param array darf <i>null</i> sein
     * @return ArrayList
     */
    ...
    /**
     * Vereint alle Maps in einer neuen. Doppelte Keys überschreiben sich in der Reihenfolge, in
     * der sie in der Collection vorkommen.
     *
     * @return HashMap
     */
    ...
    /**
     * Vereint alle Properties in einem. Doppelte Keys überschreiben sich in der Reihenfolge, in
     * der sie in der Collection vorkommen.
     *
     ...
     * der sie übergeben werden.
     *
     * @param props darf <i>null</i> sein
     * @return die vereinten Properties
     */
     ...
     *
     * @param elem darf null sein
     * @param array darf nicht null sein, wohl aber seine Elemente
     */
    ...
    /**
     * Liefert das "erste" Element von 'o'. Bei Arrays und Listen ist es das erste Element der
     * jeweiligen Struktur. Ansonsten wird einfach 'o' selbst zurückgegeben.
     *
     * @param o Object | Object[] | List
     */
     ...
     * @param p the predicate. Return <code>false</code> to discard the element
    ...
    public static <T> List<T> grep(Collection<T> c, Predicate<T> p) {
        ...
        int i = 0;
        for (T e : c) {
            if (p.evaluate(e, i)) grepped.add(e);
            i++;
        }
        return grepped;
    }
     ...
     *
     * @param <T> type of the objects this predicate  
     */
    public interface Predicate<T> {
         ...
         * @param index iteration index of the object  
         */
