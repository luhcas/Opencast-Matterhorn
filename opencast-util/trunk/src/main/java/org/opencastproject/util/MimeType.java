...
public final class MimeType implements Cloneable, Comparable<MimeType>, Serializable {
	...
	/**
	 * Creates a new mime type with the given type, subtype and
	 * main file suffix.
	 * 
	 * @param type the major type
	 * @param subtype minor type
	 * @param suffix main file suffix
	 */
	 ...
	 * <p>
	 * For example, if the mimetype is ISO Motion JPEG 2000
	 * which is represented as <code>video/mj2</code>, this
	 * method will return <code>video</code>.
	 * 
	 * @return the type
	 */
	 ...
	 * For example, if the mimetype is ISO Motion JPEG 2000
	 * which is represented as <code>video/mj2</code>, this
	 * method will return <code>mj2</code>.
	 * 
	 * @return the subtype
	 */
	...
	/**
	 * Returns the main suffix for this mime type, that
	 * identifies files containing data of this flavor.
	 * <p>
	 * For example, files with the suffix <code>mj2</code> will
	 * contain data of type <code>video/mj2</code>.
	 * 
	...
	/**
	 * Returns the registered suffixes for this mime type, that
	 * identify files containing data of this flavor. Note that the
	 * list includes the main suffix returned by <code>getSuffix()</code>.
	 * <p>
	 * For example, files containing ISO Motion JPEG 2000 may have
	 * file suffixes <code>mj2</code> and <code>mjp2</code>.
	 * 
	...
	/**
	 * Returns <code>true</code> if the mimetype supports the specified
	 * suffix.
	 * 
	 ...
	 * <p>
	 * A flavor is a hint on a specialized variant of a general mime type.
	 * For example, a dublin core file will have a mime type of
	 * <code>text/xml</code>. Adding a flavor of <code>mpeg-7</code>
	 * gives an additional hint on the file contents.
	 * 
	...
	/**
	 * Returns <code>true</code> if this mime type is an equivalent for
	 * the specified type and subtype.
	 * <p>
	 * For example, a gzipped file may have both of these mime types
	 * defined, <code>application/x-compressed</code> or
	...
	public boolean equals(Object o) {
		if (o instanceof MimeType) {
			...
			return m.isEquivalentTo(type_, subtype_) || this.isEquivalentTo(m.getType(), m.getSubtype());
		}
	...
	/**
	 * Helper class to store type/subtype equivalents for
	 * a given mime type.
	 * 
	 * @author Tobias Wunden <tobias.wunden@id.ethz.ch>
	 */
