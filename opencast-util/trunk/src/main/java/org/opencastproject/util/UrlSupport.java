...
public class UrlSupport {
	...
	/**
	 * This class should not be instanciated, since it only provides static utility
	 * methods.
	 */
	private UrlSupport() {}
	 ...
	 * does. If you need a trailing slash, see {@link #concat(String, String, boolean)}.
	 * 
	...
	/**
	 * Returns the trimmed url. Trimmed means that the url is free from leading
	 * or trailing whitespace characters, and that a directory url like <code>/news/</code>
	 * is closed by a slash (<code>/</code>).
	 * 
	...
	/**
	 * Removes any occurence of double separators ("//") and replaces
	 * it with "/".
	 * 
	 ...
	 * <p>
	 * Note that <code>a</code> is also an extended prefix of <code>b</code>
	 * if <code>a</code> and <code>b</code> are equal.
	 * 
	...
	public static boolean isPrefix(String a, String b) {
		if (isExtendedPrefix(a, b)) {
			if (a.length() < b.length()) {
				...
				if (bRest.endsWith("/")) bRest = bRest.substring(0, bRest.length() - 2);
	...
	/**
	 * Returns the url extension that <code>url</code> defines over <code>prefix</code>.
	 * For example, the extension of url <code>/news/today</code> and prefix
	 * <code>/news</code> is <code>today</code>.
	 * <p>
	 * If <code>prefix</code> is not a prefix of <code>url</code>, this method returns
	 * <code>null</code>, if <code>url</code> and <code>prefix</code> match, the empty
	 * string is returned.
	 * 
	 ...
	 * </ul>
	 * 
	 * @param url the url with extension
	...
	/**
	 * Returns <code>null</code> if the url is valid, that is, if it contains only allowed characters.
	 * Otherwhise, the invalid character is returned.
	 * 
