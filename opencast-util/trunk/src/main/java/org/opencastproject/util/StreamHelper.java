...
public class StreamHelper extends Thread {
    ...
    /**
     * Creates a new stream helper and immediately starts capturing output
    ...
    /**
     * Creates a new stream helper and immediately starts capturing output
     * from the given stream. Output will be captured to the given buffer.
     *
    ...
    /**
     * Creates a new stream helper and immediately starts capturing output
     * from the given stream. Output will be captured to the given buffer and also redirected to the
    ...
    /**
     * This method will write any output from the stream to the the content
     * buffer and the logger.
     * 
    ...
    /**
     * If a logger has been specified, the output is written to the logger
     * using the defined log level.
     * 
     * @param output the stream output
     */
