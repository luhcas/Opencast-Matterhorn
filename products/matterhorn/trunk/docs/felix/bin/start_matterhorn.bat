...
# Make sure the following two path entries do *not* contain spaces
...
java %DEBUG_OPTS% -DM2_REPO=%M2_REPO% %FELIX_FILEINSTALL_OPTS% %PAX_CONFMAN_OPTS% %CXF_OPTS% -jar %FELIX_HOME%\bin\felix.jar %FELIX_CACHE%  