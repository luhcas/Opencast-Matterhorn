...
3) Copy docs/felix_config.properties to <felix_root>/conf/config.properties and edit the matterhorn.* properties.
4) Start felix with cd <felix_root>; java -DM2_REPO=~/.m2/repository/ -jar bin/felix.jar
5) Visit http://localhost:8080/samplews?wsdl to see the sample web service endpoint or http://localhost:8080/samplejs/sample.js to see a js file mounted to the servlet container.
