...
import org.opencastproject.jcr.impl.OpencastJcrServerOsgiImpl;
...
public class CommandLineJcrInterface {
	...
	public static void main(String... args) {
		try {
			...
			OpencastJcrServer server = new OpencastJcrServerOsgiImpl(nodeNumberInput, "./target/cluster_repo_" + nodeNumberInput + "_home/");
