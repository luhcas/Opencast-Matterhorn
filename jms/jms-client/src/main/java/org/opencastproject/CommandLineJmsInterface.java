...
public class CommandLineJmsInterface {
	...
	public static void main(String... args) {
		try {
			...
			try {
				System.out.println("Type 'send <message>' to send a message to a pre-defined topic.");
				System.out.println("Type 'subscribe' to display messages sent to the topic.");
				System.out.println("Type 'unsubscribe' to stop displaying messages sent to the topic.");
				...
				while(true) {
					...
					if("quit".equals(input)) {
						...
						if(subscriber == null) {
							subscriber = session.createDurableSubscriber(topic, SUBSCRIBER_ID);
