 ...
 */
public enum SourceDeviceName {
  CUSTOM_VIDEO_SRC,     /* User Specified Source - Allows the user to specify their bin with gstreamer like syntax */
  CUSTOM_AUDIO_SRC,     /* User Specified Source - Allows the user to specify their bin with gstreamer like syntax */
