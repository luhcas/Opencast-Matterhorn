...
public class PipelineFactoryTest {
  ...
  public void testWithInvalidFileSource() {
    ...
    properties.setProperty(CaptureParameters.CAPTURE_DEVICE_PREFIX + "INVALID" + CaptureParameters.CAPTURE_DEVICE_SOURCE, "capture/invalid.mpg");
    properties.setProperty(CaptureParameters.CAPTURE_DEVICE_PREFIX + "INVALID" + CaptureParameters.CAPTURE_DEVICE_DEST, "invalid_out.mpg");
  ...
  public void testAddPipeline() {
    ...
    boolean ret;
    for (DeviceName device : deviceList) {
