...
public final class MediaPackageElementBuilderFactory {
  ...
  /** Class name for the default media package element builder */
  private static final String BUILDER_CLASS = "org.opencastproject.media.mediapackage.MediaPackageElementBuilderImpl";

  /** Name of the system property */
  public static final String PROPERTY_NAME = "org.opencastproject.mediapackage.elementbuilder";
   ...
   */
  private MediaPackageElementBuilderFactory() {
