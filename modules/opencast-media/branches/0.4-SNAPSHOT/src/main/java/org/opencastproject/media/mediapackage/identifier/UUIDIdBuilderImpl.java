...
public class UUIDIdBuilderImpl implements IdBuilder {
  ...
  /**
   * @see org.opencastproject.media.mediapackage.identifier.IdBuilder#createNew()
   */
  public Id createNew() {
  ...
  /**
   * @see org.opencastproject.media.mediapackage.identifier.IdBuilder#fromString(String)
   */
