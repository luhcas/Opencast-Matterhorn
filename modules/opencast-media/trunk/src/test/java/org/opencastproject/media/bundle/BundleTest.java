...
public class BundleTest extends AbstractBundleTest {
  ...
  /**
   * Test method for
   * {@link org.opencastproject.media.bundle.BundleImpl#add(org.opencastproject.media.bundle.Catalog)}
   * .
   */
  @Test
  public void testAddAndRemoveCatalog() {
    ...
    try {
      ...
      // Check path
      File expectedCatalogFile = new File(bundle.getCatalogRoot(), catalog
          .getFilename());
  ...
  /**
   * Test method for
   * {@link org.opencastproject.media.bundle.BundleImpl#add(org.opencastproject.media.bundle.Track)}
   * .
   */
  @Test
  ...
  /**
   * Test method for
   * {@link org.opencastproject.media.bundle.BundleImpl#add(org.opencastproject.media.bundle.Attachment)}
   * .
   */
  @Test
  public void testAddAndRemoveAttachment() {
    ...
    try {
      ...
      File expectedCoverFile = new File(bundle.getAttachmentRoot(), coverFile
          .getName());
  ...
  /**
   * Test method for
   * {@link org.opencastproject.media.bundle.BundleImpl#moveTo(File)}.
   */
  @Test
  public void testMoveTo() {
    ...
    String catalogName = bundle.getCatalogs(DublinCoreCatalog.FLAVOR)[0]
        .getFilename();
    try {
      tmpInbox.mkdirs();
      bundle.moveTo(tmpInbox);
      assertEquals(bundle.getRoot().getAbsolutePath(), newBundleRoot
          .getAbsolutePath());
      ...
      assertTrue(catalogsInBundle[0].getFile().getAbsolutePath().equals(
  ...
  public void testAddCatalogAndSave() {
    ...
    try {
      File catalogTestFile = new File(this.getClass().getResource(
          "/dublincore.xml").getPath());
    ...
    try {
      ...
      fail("Configuration error while loading bundle from manifest: "
          + e.getMessage());
    } catch (BundleException e) {
      fail("Bundle exception while loading bundle from manifest: "
          + e.getMessage());
    }
...
// FIXME  @Test
  ...
  /**
   * Test method for
   * {@link org.opencastproject.media.bundle.Bundle#getElementById(java.lang.String)}
   */
  @Test
  ...
  /**
   * Test method for
   * {@link org.opencastproject.media.bundle.Bundle#getElementByReference(org.opencastproject.media.bundle.BundleReference)}
   */
  @Test
  ...
  public void testWrap() {
    ...
    try {
      ...
      fail("Error overwriting presentation track with audio file: "
          + e.getMessage());
    }
