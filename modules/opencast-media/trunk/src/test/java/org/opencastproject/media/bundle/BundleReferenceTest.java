...
public class BundleReferenceTest extends AbstractBundleTest {
  ...
  /**
   * Test method for
   * {@link org.opencastproject.media.bundle.BundleReferenceImpl#matches(BundleReference)}
   * .
   */
  @Test
  public void testMatches() {
    ...
    BundleReference genericBundleReference = new BundleReferenceImpl("bundle",
        "*");
    BundleReference trackReference = new BundleReferenceImpl(bundle
        .getElementById("track-2"));
  ...
  public void testBundleReference() {
    try {
      ...
      File catalogXTestFile = new File(this.getClass().getResource(
      ...
      File catalogYTestFile = new File(this.getClass().getResource(
          "/dublincore.xml").getPath());
      ...
      File catalogZTestFile = new File(this.getClass().getResource(
          "/dublincore.xml").getPath());
    ...
    try {
      ...
      assertTrue(catalogZ.getReference().matches(
          new BundleReferenceImpl("track", "track-1")));
