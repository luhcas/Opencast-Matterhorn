...
public interface BundleElementBuilder {
   ...
   * <p>
   * Since only the file is given, it is possible, that the best builder plugin
   * cannot be uniquely identified and may require additional contraints, e. g.
   * a matching filename. Be sure to check the documentation of the
   * corresponding plugin for details.
   * </p>
   * 
   * @param file
   *          the file to ingest
   ...
   * plugin cannot be uniquely identified and may require additional contraints,
   * e. g. a matching filename. Be sure to check the documentation of the
   ...
   *           if creating the bundle element fails
   */
  BundleElement elementFromFile(File file, BundleElement.Type type,
