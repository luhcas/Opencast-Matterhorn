 ...
 * @version $Id$
 */
public class PresentationTrackImpl extends TrackImpl implements
    PresentationTrack {
   ...
   */
  protected PresentationTrackImpl(BundleElementFlavor flavor, File track)
   ...
   *           if the md5 checksum cannot be computed
   */
  protected PresentationTrackImpl(BundleElementFlavor flavor,
      MimeType mimeType, File track, Checksum checksum) throws IOException,
   ...
   *           if the md5 checksum cannot be computed
   */
  public static PresentationTrackImpl fromFile(File file) throws IOException,
      UnknownFileTypeException, NoSuchAlgorithmException {
   ...
   *           if the md5 checksum cannot be computed
   */
  public static PresentationTrackImpl fromFile(File file, MimeType mimeType,
      Checksum checksum) throws IOException, UnknownFileTypeException,
      NoSuchAlgorithmException {
    return new PresentationTrackImpl(PresentationTrack.FLAVOR, mimeType, file,
        checksum);
  }
