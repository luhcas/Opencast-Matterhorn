...
/**
 * This class is used to create instances of a handle builder. To specify your
 * own implementation of the handle builder, you simply have to provide the
...
public class HandleBuilderFactory {
  ...
  private static final String BUILDER_CLASS = "org.opencastproject.media.bundle.handle.HandleBuilderImpl";
   ...
   */
  public static HandleBuilderFactory newInstance()
      throws ConfigurationException {
    return factory;
  }
   ...
   * implementation of the {@link HandleBuilder} interface to use:
   * <ul>
   * <li>Implementation specified using the <code>opencast.handlebuilder</code>
   * system property</li>
    ...
    if (builder == null) {
      try {
        ...
        throw new ConfigurationException(
            "Class not found while creating handle builder: " + e.getMessage(),
            e);
      } catch (InstantiationException e) {
        throw new ConfigurationException(
            "Instantiation exception while creating handle builder: "
                + e.getMessage(), e);
      } catch (IllegalAccessException e) {
        throw new ConfigurationException(
            "Access exception while creating handle builder: " + e.getMessage(),
            e);
      }
    }
    return builder;
