 ...
 * @version $Id$
 */
public class ContentSegmentImpl implements ContentSegment, AudioSegment,
    VideoSegment, AudioVisualSegment {
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#getIdentifier()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#setMediaTime(org.opencastproject.media.bundle.mpeg7.MediaTime)
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#getMediaTime()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#hasTextAnnotations()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#hasTextAnnotations(java.lang.String)
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#hasTextAnnotations(float,
   *      float)
   */
  ...
  public boolean hasTextAnnotations(float relevance, float confidence,
    ...
    for (TextAnnotation annotation : annotations) {
      if (annotation.getRelevance() >= relevance
          && annotation.getConfidence() >= confidence) {
        if (language != null) {
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#getTextAnnotationCount()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#textAnnotationsByConfidence()
   */
  public Iterator<TextAnnotation> textAnnotationsByConfidence() {
    SortedSet<TextAnnotation> set = new TreeSet<TextAnnotation>(
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#textAnnotationsByRelevance()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#createTextAnnotation(float,
   *      float, String)
   */
  public TextAnnotation createTextAnnotation(float relevance, float confidence,
      String language) {
    TextAnnotationImpl annotation = new TextAnnotationImpl(relevance,
        confidence, language);
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.ContentSegment#textAnnotations()
   */
