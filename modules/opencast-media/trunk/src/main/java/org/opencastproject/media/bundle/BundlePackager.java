...
/**
 * Interface describing a bundle packager, that will, for example, pack a bundle
 * structure into a jar file.
 * 
...
public interface BundlePackager {
   ...
   */
  void pack(Bundle bundle, OutputStream out) throws IOException,
      BundleException;
