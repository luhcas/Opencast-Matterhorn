...
public class AttachmentImpl extends AbstractMediaPackageElement implements Attachment {
   ...
   */
  protected AttachmentImpl(MediaPackageElementFlavor flavor, File file, Checksum checksum) throws IOException,
   ...
   *           if the specified file does not exist or cannot be created
   */
  protected AttachmentImpl(MediaPackageElementFlavor flavor, MimeType mimeType, File file, Checksum checksum)
          throws IOException {
   ...
   */
  protected AttachmentImpl(MediaPackageElementFlavor flavor, MimeType mimeType, File file) throws IOException,
   ...
   * 
   * @param id
   *          the identifier within the media package
   * @param flavor
   *          the attachment type
   * @param mimeType
   *          the attachment's mime type
   ...
   *           if the specified file does not exist or cannot be created
   */
  protected AttachmentImpl(String id, MediaPackageElementFlavor flavor, MimeType mimeType, File file, Checksum checksum)
          throws IOException {
   ...
   *           if the attachment's checksum cannot be computed
   */
  protected AttachmentImpl(MediaPackageElementFlavor flavor, File file) throws IOException, NoSuchAlgorithmException,
          UnknownFileTypeException {
   ...
   */
  public static AttachmentImpl fromFile(File file) throws IOException, UnknownFileTypeException,
          NoSuchAlgorithmException {
