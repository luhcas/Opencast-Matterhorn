...
/**
 * This interface is mainly intended to encapsulate Dublin Core metadata, but it
 * is also capable of maintaining proprietary metadata alongside the Dublin
 * Core.
 * <p/>
 * Dublin Core is an initiative to create a digital "library card catalog" for
 * the Web. Dublin Core, in its simple form, is made up of 15 metadata (data
 * that describes data) elements that offer expanded cataloging information and
 * improved document indexing for search engine programs.
 * <p/>
 * Two forms of Dublin Core exist: <def>Simple Dublin Core</def> and
 * <def>Qualified Dublin Core</def>. Simple Dublin Core expresses properties as
 * literal strings using just the 15 metadata elements from the Dublin Core
 * Metadata Element Sets. Each element can have multiple values, but order is
 * defined. Values may have an associated language. <br>
 * Please see <a
 * href="http://dublincore.org/documents/dces/">http://dublincore.org
 * /documents/dces/</a> for further information.
 * <p/>
 * Qualified Dublin Core increases the specificity of metadata by extending the
 * set of properties (elements) and by adding information about encoding
 * schemes. While enabling searches to be more specific, qualifiers are also
 * more complex and can pose challenges to interoperability. <br>
 * Please see <a
 * href="http://dublincore.org/documents/dcmi-terms/">http://dublincore
 * .org/documents/dcmi-terms/</a> and <a
 * href="http://dublincore.org/documents/dc-xml-guidelines/"
 * >http://dublincore.org/documents/dc-xml-guidelines/</a> Section 5 for further
 * information.
 * <p/>
 * <h3>Current limitations</h3>
 * <ul>
 * <li>This interface assumes that Dublin Core metadata is stored as XML.
 * According to the Dublin Core specification this is not necessary.
...
public interface DublinCore {
   ...
   * >http://dublincore.org/documents/dcmi-terms/</a> for details.
   */
   ...
   * >http://dublincore.org/documents/dces/</a> for details.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-abstract">DCMI
   * Terms Abstract</a>.
   */
  EName PROPERTY_ABSTRACT = new EName(TERMS_NS_URI, "abstract");

  /**
   * Dublin Core Property <dfn>accessRights</dfn> in the /terms/ namespace. See
   * <a href="http://dublincore.org/documents/dcmi-terms/#terms-accessRights">
   * DCMI Terms Access Rights</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-available">DCMI
   * Terms Date Available</a>.
   */
  EName PROPERTY_AVAILABLE = new EName(TERMS_NS_URI, "available");

  /**
   * Dublin Core Property <dfn>contributor</dfn> in the /terms/ namespace. See
   * <a
   * href="http://dublincore.org/documents/dcmi-terms/#terms-contributor">DCMI
   * Terms Contributor</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-coverage">DCMI
   * Terms Coverage</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-created">DCMI Terms
   * Date Created</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-creator">DCMI Terms
   * Creator</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-date">DCMI Terms
   * Date</a>.
   */
  EName PROPERTY_DATE = new EName(TERMS_NS_URI, "date");

  /**
   * Dublin Core Property <dfn>description</dfn> in the /terms/ namespace. See
   * <a
   * href="http://dublincore.org/documents/dcmi-terms/#terms-description">DCMI
   * Terms Description</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-extent">DCMI Terms
   * Extent</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-format">DCMI Terms
   * Format</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-identifier">DCMI
   * Terms Identifier</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-isPartOf">DCMI
   * Terms Is Part Of</a>.
   */
   ...
   * See <a
   * href="http://dublincore.org/documents/dcmi-terms/#terms-"isReferencedBy
   * >DCMI Terms Is Referenced By</a>.
   */
  EName PROPERTY_IS_REFERENCED_BY = new EName(TERMS_NS_URI, "isReferencedBy");

  /**
   * Dublin Core Property <dfn>isReplacedBy</dfn> in the /terms/ namespace. See
   * <a href="http://dublincore.org/documents/dcmi-terms/#terms-isReplacedBy">
   * DCMI Terms Is Replaced By</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-language">DCMI
   * Terms Language</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-license">DCMI Terms
   * License</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-publisher">DCMI
   * Terms Publisher</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-replaces">DCMI
   * Terms Replaces</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-rights">DCMI Terms
   * Rights</a>.
   */
  EName PROPERTY_RIGHTS = new EName(TERMS_NS_URI, "rights");

  /**
   * Dublin Core Property <dfn>rightsHolder</dfn> in the /terms/ namespace. See
   * <a href="http://dublincore.org/documents/dcmi-terms/#terms-rightsHolder">
   * DCMI Terms Rights Holder</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-source">DCMI Terms
   * Source</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-spatial">DCMI Terms
   * Spatial</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-subject">DCMI Terms
   * Subject</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-temporal">DCMI
   * Terms Temporal</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-title">DCMI Terms
   * Title</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#terms-type">DCMI Terms
   * Type</a>.
   */
   ...
   * href="http://dublincore.org/documents/dcmi-terms/#H5"
   * >http://dublincore.org/documents/dcmi-terms/#H5</a>
   */
   ...
   * <p/>
   * Use this code whenever you need values in <em>all</em> languages or you
   * don't care about the language. Note that all methods taking this as a legal
   * value for the language parameter are adviced to return at first a value for
   * {@link #LANGUAGE_UNDEFINED} if multiple values exist and only one value is
   * wanted.
   */
  String LANGUAGE_ANY = "**";

  /**
   * Get all values of a property, either in a certain language or in all
   * contained languages.
   * 
   * @param property
   *          the property qname
   * @param language
   *          a language code, {@link #LANGUAGE_UNDEFINED} or
   *          {@link #LANGUAGE_ANY}
  ...
  /**
   * Like {@link #get(EName, String)} but returns only the first value of the
   * list. This method is intended to be a convenience method for those
   * properties that have only one value.
   * <p/>
  ...
  /**
   * Get the first value of a property, no matter what language it is in. Like a
   * call of {@link #getFirst(EName, String)} with
   * <code>language = {@link #LANGUAGE_ANY}</code>. Please not that values with
   * an {@link #LANGUAGE_UNDEFINED undefined language} are returned preferably.
   * 
   * @param property
   *          the property qname
   * @return the value or null
   ...
   * @param property
   *          the property qname
   * @return a set of languages which may be empty in case the property does not
   *         have any value. Note that the state of having no language defined (
   *         {@link #LANGUAGE_UNDEFINED}) is treated like a language.
   */
  ...
  /**
   * Check if a property has at least on value without language information
   * assigned. Like a call of {@link #hasValue(EName)} with
   * <code>language = {@link #LANGUAGE_ANY}</code>
   * 
   * @param property
   *          the property qname
   */
  ...
  /**
   * Set a property to the given value, overwriting an existing value in the
   * given language.
   * <p/>
   * Please note that it is not allowed to pass {@link #LANGUAGE_ANY} as
   * <code>language</code>.
   * 
   * @param property
   *          the property qname
   * @param value
   *          the value or null to remove all values of the given language for
   *          this property
   * @param language
  ...
  /**
   * Set a value without language information to a property, overwriting an
   * existing value. This is like calling {@link #set(EName, String, String)}
   * with <code>language = {@link #LANGUAGE_UNDEFINED}</code>
   * 
   * @param property
   *          the property qname
   * @param value
   *          the value or null to remove all values of
   *          {@link #LANGUAGE_UNDEFINED} for this property
   */
   ...
   *          the property qname
   * @param value
   *          the value or null to completely remove the property (all values in
   *          all languages)
   */
  ...
  /**
   * Add a value without language information to a property. This is like
   * calling {@link #add(EName, String, String)} with
   * <code>language = {@link #LANGUAGE_UNDEFINED}</code>
   * 
   * @param property
   *          the property qname
   * @param value
   ...
   * <li> {@link #LANGUAGE_UNDEFINED}: remove only values with no language
   * information
  ...
  /**
   * Bind a prefix to a namespace name to support proprietary metadata
   * properties. For further information about namespaces and their binding,
   * please see <a
