...
public interface HandleBuilder {
   ...
   * hand over a new instance for the default url. Do not forget to update the
   * handle once the final url is known.
   * 
  ...
  /**
   * Creates a handle object from the specified value. The value must be a valid
   * handle in string form, e. g. <code>10.254/test</code>, optionally preceeded
   * by the handle protocol identifier {@link Handle#PROTOCOL};
   * 
   * @param value
   *          the handle value
   * @return the handle
