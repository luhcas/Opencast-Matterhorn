 ...
 * @version $Id: TemporalDecompositionImpl.java 102 2009-04-03 20:05:36Z wunden
 *          $
 */
public class TemporalDecompositionImpl<T extends ContentSegment> implements
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.TemporalDecomposition#setGap(boolean)
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.TemporalDecomposition#hasGap()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.TemporalDecomposition#hasSegments()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.TemporalDecomposition#setOverlapping(boolean)
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.TemporalDecomposition#setCriteria(org.opencastproject.media.bundle.mpeg7.TemporalDecomposition.DecompositionCriteria)
   */
  public void setCriteria(DecompositionCriteria criteria) {
    if (criteria == null)
      throw new IllegalArgumentException(
          "Decomposition criteria must not be null");
    this.criteria = criteria;
  }

  /**
   * @see org.opencastproject.media.bundle.mpeg7.TemporalDecomposition#isOverlapping()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.TemporalDecomposition#getCriteria()
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.TemporalDecomposition#getSegmentById(java.lang.String)
   */
  ...
  /**
   * @see org.opencastproject.media.bundle.mpeg7.TemporalDecomposition#segments()
   */
