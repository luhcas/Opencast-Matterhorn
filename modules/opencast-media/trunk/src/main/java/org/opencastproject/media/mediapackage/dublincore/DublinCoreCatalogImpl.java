...
public class DublinCoreCatalogImpl extends XMLCatalogImpl implements DublinCoreCatalog {
  ...
  /** Indicator for lazy loading status */
   ...
   */
  public static DublinCoreCatalog fromFile(File catalog) {
   ...
   * @return the dublin core object
   */
  public static DublinCoreCatalogImpl fromURI(URI uri) {
    DublinCoreCatalogImpl dc = new DublinCoreCatalogImpl();
    dc.setURI(uri);
    dc.isLoaded = false;
    return dc;
  }
  ...
  private void loadCatalogData() throws IllegalStateException {
    ...
    try {
      ...
      isLoaded = false;
      throw new IllegalStateException("Unable to load dc catalog data from " + uri + ":" + e.getMessage(), e);
    }
  }

  /**
   * Returns a text representation of the dublin core content. It is intended to be used to easily search the catalog.
   * 
