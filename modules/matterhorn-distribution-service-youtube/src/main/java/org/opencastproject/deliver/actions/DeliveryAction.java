...
/**
 * Action to deliver a media item to a destination. Specific actions needed
 * to accomplish delivery are implemented in subclasses.
 *
...
public abstract class DeliveryAction extends Action {
    ...
    /**
     * Checks the members of the delivery action to insure that all required
     * members are set and that all values are valid.
     */
