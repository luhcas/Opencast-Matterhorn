...
public class ScheduledEventImpl implements ScheduledEvent{
   ...
   * @param start The start time of the event as a Unix timestamp
  ...
  static class Adapter extends XmlAdapter<ScheduledEventImpl, ScheduledEvent> {
    public ScheduledEventImpl marshal(ScheduledEvent op) throws Exception {return (ScheduledEventImpl)op;}
    public ScheduledEvent unmarshal(ScheduledEventImpl op) throws Exception {return op;}
  }
