			...
			<xsl:when test="ns2:episode/videoUrl">
						...
						<tr>
								...
								<div id="simpleEdit">
									...
									<span id="editorContainer" name="Edit Current Time" title="Edit Current Time"
										...
										<input id="editField" type="text" maxlength="9" size="9"
											...
											value="Edit Current Time HH:MM:SS" onKeyPress="Opencast.Player.editTimeKeyListener(event);"
											onchange="Opencast.Player.editTime();" onFocus="Opencast.Player.doPause();"
											onBlur="Opencast.Player.doPlay();" />
									</span>
									of
									<span id="time-total" role="timer" name="Total Time"
										title="Total Time" tabIndex="0">00:00:00</span>
								</div>
							</td>

							<td align="center" valign="middle" style="padding-left:0">
								<button id="btn_skip_backward" class="btn_skip_backward"
									onmouseover="this.className='btn_skip_backward_over'"
									onmouseout="this.className='btn_skip_backward_out'" type="submit"
									onclick="Opencast.Player.doSkipBackward();" name="Skip Backward"
									value="Skip Backward" alt="Skip Backward" title="Skip Backward"></button>
								<button id="btn_rewind" class="btn_rewind"
									onmouseover="this.className='btn_rewind_over'" onmouseout="this.className='btn_rewind_out'"
									type="submit" onclick="Opencast.Player.doRewind();" name="Rewind"
									value="Rewind" alt="Rewind" title="Rewind"></button>
								<button id="btn_play_pause" class="btn_play"
									onmouseover="Opencast.Player.PlayPauseMouseOver();" onmouseout="Opencast.Player.PlayPauseMouseOut();"
									type="submit" onclick="Opencast.Player.doTogglePlayPause();"
								...
								<button id="btn_fast_forward" class="btn_fast_forward"
									...
									type="submit" onclick="Opencast.Player.doFastForward();" name="Fast Forward"
									value="Fast Forward" alt="Fast Forward" title="Fast Forward"></button>
								<button id="btn_skip_forward" class="btn_skip_forward"
									onmouseover="this.className='btn_skip_forward_over'"
									onmouseout="this.className='btn_skip_forward_out'" type="submit"
									onclick="Opencast.Player.doSkipForward();" name="Skip Forward"
									value="Skip Forward" alt="Skip Forward" title="Skip Forward"></button>
							</td>

							<td align="center" valign="middle" style="padding-right:0">
								<button id="btn_volume" class="oc-btn-volume-high" type="submit"
									onclick="Opencast.Player.doToggleVolume();" name="Unmute"
							...
							<td align="center" valign="middle" style="padding-right:5">
								<button id="btn_cc" class="oc-btn-cc-off" type="submit"
									onclick="Opencast.Player.doToogleClosedCaptions();" name="Closed Caption Off"
				...
				<div id="oc-video-display-container">
					<object
						...
						height="320" width="400" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
