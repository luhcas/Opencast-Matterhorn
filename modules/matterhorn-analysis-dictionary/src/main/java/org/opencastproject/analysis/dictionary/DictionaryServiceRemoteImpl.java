...
public class DictionaryServiceRemoteImpl extends DictionaryService {

  private static final Logger logger = LoggerFactory.getLogger(DictionaryServiceRemoteImpl.class);

  public static final String REMOTE_DICTIONARY = "remote.dictionary";
  ...
  public void activate(ComponentContext cc) {
    this.remoteHost = cc.getBundleContext().getProperty(REMOTE_DICTIONARY);
  }

  @Override
  public Receipt clean(Mpeg7Catalog catalog, boolean block) {
    logger.info("Cleaning an Mpeg7Catalog(" + catalog.getIdentifier() + ") on a remote server: " + remoteHost);
    String remoteHostMethod = remoteHost + "/dictionary/rest/clean";
    List<BasicNameValuePair> params = new ArrayList<BasicNameValuePair>();
    UrlEncodedFormEntity entity;
    try {
      params.add(new BasicNameValuePair("catalog", getXML(catalog)));
  ...
  public Receipt getReceipt(String id) {
    ...
    String url = remoteHost + "/dictionary/rest/receipt/" + id + ".xml";
