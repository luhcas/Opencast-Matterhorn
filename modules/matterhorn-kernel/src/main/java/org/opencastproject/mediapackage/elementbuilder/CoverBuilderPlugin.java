...
import org.opencastproject.mediapackage.attachment.CoverImpl;
...
public class CoverBuilderPlugin extends AbstractAttachmentBuilderPlugin implements MediaPackageElementBuilderPlugin {
  ...
  /**
   * Creates a new attachment builder that will accept attachments of type {@link org.opencastproject.mediapackage.Cover}.
   */
  ...
  /**
   * @see org.opencastproject.mediapackage.elementbuilder.AbstractAttachmentBuilderPlugin#specializeAttachment(org.opencastproject.mediapackage.Attachment)
   */
  @Override
