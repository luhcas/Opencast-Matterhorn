...
public class WorkflowInstanceTest {
  ...
  public void testMediaPackageSerializationInWorkflowInstance() throws Exception {
    ...
    src.toXmlStream(out, true);
    MediaPackage deserialized = MediaPackageBuilderFactory.newInstance().newMediaPackageBuilder().loadFromManifest(new ByteArrayInputStream(out.toByteArray()));
  ...
  public void testMediaPackageDeserialization() throws Exception {
    ...
    MediaPackage src = MediaPackageBuilderFactory.newInstance().newMediaPackageBuilder().loadFromManifest(IOUtils.toInputStream(xml));
    workflow.setSourceMediaPackage(src);
