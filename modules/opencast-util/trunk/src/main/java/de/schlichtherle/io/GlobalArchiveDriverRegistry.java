...
final class GlobalArchiveDriverRegistry extends ArchiveDriverRegistry {
    ...
    private void registerArchiveDrivers() {
        ...
        if(services == null || services.length == 0) {
          ...
          URL regUrl = GlobalArchiveDriverRegistry.class.getClassLoader().getResource("META-INF/services/de.schlichtherle.io.registry.properties");
          logger.info("registering default registry.properties");
          registerArchiveDrivers(regUrl, this, clientRegistry);
        } else {
    ...
    private static void registerArchiveDrivers(
        ...
        try {
            ClassLoader l = GlobalArchiveDriverRegistry.class.getClassLoader();
            if (l == null)
