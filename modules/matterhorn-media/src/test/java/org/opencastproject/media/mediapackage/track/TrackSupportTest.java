...
public class TrackSupportTest {
  ...
  public void testByType() throws Exception {
    TrackImpl t = new TrackImpl(MediaPackageElements.PRESENTER_TRACK, MimeTypes.parseMimeType("video/avi"), new URI("http://foo"), 100L, Checksum.create(ChecksumType.DEFAULT_TYPE, "1234"));
