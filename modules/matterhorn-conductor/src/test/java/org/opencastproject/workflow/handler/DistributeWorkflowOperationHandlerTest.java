...
import org.opencastproject.workflow.handler.DistributeWorkflowOperationHandler;
...
public class DistributeWorkflowOperationHandlerTest {
  ...
  public void setup() throws Exception {
    ...
    EasyMock.expect(service.distribute((MediaPackage) EasyMock.anyObject(), (String[]) EasyMock.anyObject()))
            .andReturn(mp);
  ...
  public void testDistributeOperation() throws Exception {
    ...
    // workflowInstance.getCurrentOperation().setConfiguration("source-tags", value);
    // workflowInstance.getCurrentOperation().setConfiguration("target-tags", value);
