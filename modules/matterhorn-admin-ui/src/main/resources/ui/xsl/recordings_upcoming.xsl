...
<!--
    ...
    Author     : wulff
    Description:
        Transforms output of /admin/recordings/upcoming to HTML table
-->
    ...
    <table id="recordingsTable" class="fl-theme-coal wu-table-list" width="100%" style="float:left;">
      <thead>
        <tr>
          ...
          <th width="15%" id="th-StartDate" class="sortable date-column recording-Table-head">Upload / Recording Time</th>
