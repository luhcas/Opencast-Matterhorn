          ...
          <div id="uploadContainerMulti" style="display:none;">
            ...
            <fieldset class="upload-widget">
              ...
              <div class="informationText">
                Contains discrete images/slides/scenes; may also include audio.
              </div>
              <ul class="oc-ui-form-list">
                <li class="ui-helper-clearfix" id="regularFileSelection">
            ...
            <fieldset class="upload-widget">
              ...
              <div class="informationText">
                Has no clear changes that could identify new segments; may include audio but if you select an Audio-only file below, the audio in this video-containing file will be ignored.
              </div>
              <ul class="oc-ui-form-list">
                <li class="ui-helper-clearfix" id="regularFileSelection">
                  <label class="scheduler-label"><span class="i18n_file_location">File Location</span>:</label>
