...
uploadUI.showProgressOverlay = function() {
  ...
  // for Linux OS progress bar is not supported
  if (navigator.appVersion.match(/X11/)) {
    document.getElementById("uploadProgressOverlayLinux").style.display = "block";
  } else {
...
uploadUI.hideProgressOverlay = function() {
  ...
  document.getElementById('uploadProgressOverlayLinux').style.display = 'none';
}
