...
//  }
  ...
  private String generateDocs() {
    ...
    // abstract
    data.setAbstract("This service creates and augments Matterhorn media packages that include media tracks, metadata catalogs and attachments. Please see the <a href='http://wiki.opencastproject.org/confluence/display/open/IngestService'>service contract</a> for further information.");
